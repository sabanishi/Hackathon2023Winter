...
namespace Sabanishi.Editor
{
    public class AssetObserver : AssetPostprocessor
    {
            ...
            string[] movedAssets, string[] movedFromAssetsPath)
        {
            ...
            string[] directorySENames =
                Directory.GetDirectories("Assets/Sound/SE", "*", System.IO.SearchOption.AllDirectories);
            string[] directoryBGMNames =
                Directory.GetDirectories("Assets/Sound/BGM", "*", System.IO.SearchOption.AllDirectories);
        ...
        private static void Create()
        {
            ...
            foreach (var name in seNames)
            {
                ...
                {
                    string newName = capitalName.Substring(name.LastIndexOf("/") + 1).Replace(".WAV", "")
                        .Replace(".MP3", "");
                    seList.Add(newName);
            ...
            foreach (var name in bgmNames)
            {
                ...
                {
                    string newName = capitalName.Substring(name.LastIndexOf("/") + 1).Replace(".WAV", "")
                        .Replace(".MP3", "").Replace("LOOP", "").ToUpper();
                    bgmList.Add(newName);
            ...
            string[] bgmNames2 =
                Directory.GetFiles("Assets/Sound/BGM/Intro", "*", System.IO.SearchOption.AllDirectories);
